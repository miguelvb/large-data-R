...
// [[Rcpp::export]]
List subset_cpp( DataFrame data, IntegerVector indxs){
...
// [[Rcpp::export]]
List get_subset_split(DataFrame Dsexp, List split_idx, int beg_index, int end_index, Function fun )
{
...
for (int i=beg ; i < end ; i++){
   ...
   List sub_data = subset_cpp(data, idx_); 
...
// [[Rcpp::export]]
Rcpp::List get_split_indexes(Rcpp::DataFrame Dsexp, SEXP split_row_name)
{
...
// [[Rcpp::export]]
DataFrame get_chunks_indexes_for_split_list(DataFrame data_, List split_indx, int chk_size){
